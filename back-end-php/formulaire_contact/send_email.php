...
$mail = new Mail();
$mail->setFrom('info.arcadiazoo@gmail.com', 'contact visiteur');
$mail->setSubject($subject);
$mail->addTo('info.arcadiazoo@gmail.com', 'Arcadia Zoo');

$emailContent = "Vous avez reçu un nouveau message de contact de la part d'un visiteur.\n\n";
$emailContent .= "Email: $email\n";
$emailContent .= "Objet: $subject\n";
