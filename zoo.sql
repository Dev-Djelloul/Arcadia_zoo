...
--
-- Hôte : localhost
-- Généré le : sam. 26 oct. 2024 à 04:09
...
--
ALTER TABLE `CommentairesHabitats`
  MODIFY `IdCommentaire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT pour la table `ComptesRendusVeterinaires`
--
ALTER TABLE `ComptesRendusVeterinaires`
  MODIFY `IdCompteRendu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
